...
export function Home() {
  return (
    <>
      ...
      <footer>
        <Navbar fixed='bottom' className='bg-dark justify-content-between footer px-3 py-1 '>
          <span className='text-muted font-weight-lighter '>Copyright © {new Date().getFullYear()} Vazra. MIT License.</span>
          <span className='text-muted float-right font-weight-lighter'>v{version}</span>
        </Navbar>
      </footer>
    </>
  )
