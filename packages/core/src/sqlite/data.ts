...
// const _filterDoc = (doc: IDoc, tableName: string, collections: ICollectionDetails) => {
//   const newDoc: IDoc = {}
//   const allowedFields = collections.fields[tableName]
//   allowedFields.push(['id', 'string'])
...
//     console.log(`kkk insertDataToTable deleted(${deletedCount}/${docs.length}) and inserted ${resInsert.length} `)
